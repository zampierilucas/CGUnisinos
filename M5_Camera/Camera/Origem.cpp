/* Hello Triangle - c�digo adaptado de
...
int main() {
  ...
  Shader shader("Camera/Phong.vs", "Camera/Phong.fs");
  ...
  // Matriz de proje��o perspectiva - definindo o volume de visualiza��o
  // (frustum)
...
// Fun��o de callback de teclado - s� pode ter uma inst�ncia (deve ser est�tica
// se estiver dentro de uma classe) - � chamada sempre que uma tecla for
...
// Esta fun��o est� bastante harcoded - objetivo � criar os buffers que
// armazenam a geometria de um tri�ngulo Apenas atributo coordenada nos v�rtices
// 1 VBO com as coordenadas, VAO com apenas 1 ponteiro para atributo
// A fun��o retorna o identificador do VAO
int setupGeometry() {
  // Aqui setamos as coordenadas x, y e z do tri�ngulo e as armazenamos de forma
  // sequencial, j� visando mandar para o VBO (Vertex Buffer Objects)
  // Cada atributo do v�rtice (coordenada, cores, coordenadas de textura,
  // normal, etc) Pode ser arazenado em um VBO �nico ou em VBOs separados
  GLfloat vertices[] = {
      ...
      // Ch�o
      // x    y    z    r    g    b
      -5.0, -0.5, -5.0, 0.5, 0.5, 0.5, -5.0, -0.5, 5.0, 0.5, 0.5, 0.5, 5.0, -0.5, -5.0, 0.5, 0.5, 0.5,
  ...
  // de v�rtices e os ponteiros para os atributos
...
int loadSimpleOBJ(string filepath, int& nVerts, glm::vec3 color) {
  ...
  // Observe que isso � permitido, a chamada para glVertexAttribPointer
  // registrou o VBO como o objeto de buffer de v�rtice atualmente vinculado -
  // para que depois possamos desvincular com seguran�a
  glBindBuffer(GL_ARRAY_BUFFER, 0);

  // Desvincula o VAO (� uma boa pr�tica desvincular qualquer buffer ou array
